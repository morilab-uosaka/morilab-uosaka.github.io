...
私たちの研究室では、有機化学と光化学を基盤に、新しい分子機能や反応の開拓に取り組んでいます。研究に誠実に向き合い、実験を通じて学ぶ姿勢を大切にする方を、全国の大学から広く歓迎します。
...
Doctoral students are expected to pursue independent research, publish first-author papers, plan and manage projects, mentor junior students, and communicate their findings internationally. We provide support for JSPS DC fellowship applications, RA/TA positions, tuition waivers, and applications to private foundations (all subject to competitive review). Working professionals and international students are welcome, and research can be conducted in either Japanese or English. Admission is through the entrance examination of the [Department of Applied Chemistry](https://www.applchem.eng.osaka-u.ac.jp), Graduate School of Engineering, Osaka University. Please see the latest [application guidelines](https://www.applchem.eng.osaka-u.ac.jp/admission/) for details. An initial online meeting is recommended.

博士後期課程を目指す学生には、下記のフェローシップ制度への応募を積極的に支援しています。日本学術振興会特別研究員制度に加え、大阪大学次世代研究者挑戦的研究プログラムにも応募が可能です。

We also actively support doctoral applicants in applying for fellowship programs, including the JSPS Research Fellowship for Young Scientists and Osaka University’s Next-Generation Fellowship Program.
...
#### [大阪大学次世代研究者挑戦的研究プログラム](https://itgp.osaka-u.ac.jp/jisedai/)
...
#### [JSPS Research Fellowship for Young Scientists](https://www.jsps.go.jp/english/e-pd/index.html)

- Research allowance: ¥200,000/month  
- Research expenses: up to ¥1,500,000/year  
- Application deadline: mid-May (annually)  
- Notification of results: around October  

#### [Osaka University Next-Generation Fellowship Program](https://itgp.osaka-u.ac.jp/jisedai/)

- Research allowance: ¥180,000/month  
- Research expenses: ¥480,000/year  
